...
export function setup() {
    ...
    console.log(
        `CART_ADD_MAX_RETRIES=${__ENV.CART_ADD_MAX_RETRIES || '3'}, CART_ADD_RETRY_DELAY_MS=${__ENV.CART_ADD_RETRY_DELAY_MS || '30'}`
    );
    console.log(
        `CART_ADD_LIMIT_FALLBACK=${__ENV.CART_ADD_LIMIT_FALLBACK || 'true'}, CART_TYPE_LIMIT=${__ENV.CART_TYPE_LIMIT || '10'}`
    );
